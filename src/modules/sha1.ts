 ...
 */
/*
 * Rewritten to typescript by Benjamin P.M. Lovegood, 2019
 */
/*
...
export function str_sha1(s: string) {
    return binb2str(core_sha1(str2binb(s), s.length * chrsz));
}
export function hex_hmac_sha1(key: string, data: string) {
    return binb2hex(core_hmac_sha1(key, data));
}
export function b64_hmac_sha1(key: string, data: string) {
    return binb2b64(core_hmac_sha1(key, data));
}
export function str_hmac_sha1(key: string, data: string) {
